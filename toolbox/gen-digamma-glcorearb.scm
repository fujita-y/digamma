...
(call-with-port
  ...
  (lambda (port)
    ...
    (format port ";;; Copyright (c) 2004-2020 Yoshikatsu Fujita / LittleWing Company Limited.~%")
    (format port ";;; See LICENSE file for terms and conditions of use.~%~%")
    (format port "(library (digamma glcorearb)~%")
    (output-exports port exports)
    (format port "  (import (core) (digamma c-ffi))~%")
