...
(define (test name expr expected)
  ...
  (let* ((code (compile expr))
    ...
    (vm-set-global! vm '/ /)
    (vm-set-global! vm '= =)
    (vm-set-global! vm 'list list)
    (vm-set-global! vm 'cons cons)
    (vm-set-global! vm 'car car)
    (vm-set-global! vm 'cdr cdr)
    (vm-set-global! vm 'null? null?)
    (vm-set-global! vm 'display display)
    (vm-set-global! vm 'newline newline)
