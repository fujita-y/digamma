  ...
  run_test("NQueensTest", [](CodegenTest& env) -> bool {
    ...
    scm_obj_t nqueens_code = env.read_code(R"(
      ((make-closure r0 C1 () #f 1 #f) (global-set! nqueens r0) (ret)
       ...
       (label C2) (mov r1 r0) (const r0 '*undefined*) (mov r2 r0) (closure-self r2) (make-closure r0 C3 (r2) #f 2 #f) (mov r2 r0) (mov r3 r1) (const r0 ()) (mov r4 r0) (mov r5 r2) (mov r0 r3) (mov r1 r4) (tail-call r5 2)
