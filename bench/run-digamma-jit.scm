...
;;  ack     (x3)
;;  2.487092 real    4.739758 user    0.098475 sys
;;  ----------------------------------------------------------------generating native code: create-n
;;  diviter (x200000)
;;  0.670548 real    1.185473 user    0.014776 sys
;;  ----------------------------------------------------------------generating native code: create-n
;;  divrec  (x140000)
;;  0.940155 real    1.610179 user    0.019855 sys
;;  ----------------------------------------------------------------generating native code: listn
;;  takl    (x35)
;;  0.316572 real    0.315882 user    0.000493 sys
;;  ----------------------------------------------------------------
;;  fib     (x1)
;;  0.871655 real    0.870787 user    0.000556 sys
;;  ----------------------------------------------------------------
