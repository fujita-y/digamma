...
// mat4x4-identity
scm_obj_t
subr_mat4x4_identity(VM* vm, int argc, scm_obj_t argv[])
{
...
// mat4x4-dup
scm_obj_t
subr_mat4x4_dup(VM* vm, int argc, scm_obj_t argv[])
{
    TWO_MAP_OP(mat4x4_dup, "mat4x4-dup");
}

// mat4x4-transpose
scm_obj_t
subr_mat4x4_transpose(VM* vm, int argc, scm_obj_t argv[])
{
    TWO_MAP_OP(mat4x4_transpose, "mat4x4-transpose");
}

// mat4x4-invert
scm_obj_t
subr_mat4x4_invert(VM* vm, int argc, scm_obj_t argv[])
{
    TWO_MAP_OP(mat4x4_invert, "mat4x4-invert");
}

// mat4x4-orthonormalize
scm_obj_t
subr_mat4x4_orthonormalize(VM* vm, int argc, scm_obj_t argv[])
{
    TWO_MAP_OP(mat4x4_invert, "mat4x4-orthonormalize");
}

// mat4x4-add
scm_obj_t
subr_mat4x4_add(VM* vm, int argc, scm_obj_t argv[])
{
    THREE_MAT4X4_OP(mat4x4_add, "mat4x4-add");
}

// mat4x4-sub
scm_obj_t
subr_mat4x4_sub(VM* vm, int argc, scm_obj_t argv[])
{
    THREE_MAT4X4_OP(mat4x4_sub, "mat4x4-sub");
}

// mat4x4-sub
scm_obj_t
subr_mat4x4_mul(VM* vm, int argc, scm_obj_t argv[])
{
    THREE_MAT4X4_OP(mat4x4_mul, "mat4x4-mul");
}

// mat4x4-scale
scm_obj_t
subr_mat4x4_scale(VM* vm, int argc, scm_obj_t argv[])
{
...
// mat4x4-translate
scm_obj_t
subr_mat4x4_translate(VM* vm, int argc, scm_obj_t argv[])
{
...
// mat4x4-frustum
scm_obj_t
subr_mat4x4_frustum(VM* vm, int argc, scm_obj_t argv[])
{
...
// mat4x4-ortho
scm_obj_t
subr_mat4x4_ortho(VM* vm, int argc, scm_obj_t argv[])
{
    ONE_MAT4X4_OP_BEGIN(7);
    float param[6];
    for (int i = 1; i <= 6; i++) {
...
// mat4x4-perspective
scm_obj_t
subr_mat4x4_perspective(VM* vm, int argc, scm_obj_t argv[])
{
...
// mat4x4-look-at
scm_obj_t
subr_mat4x4_look_at(VM* vm, int argc, scm_obj_t argv[])
{
...
// mat4x4-rotate
scm_obj_t
subr_mat4x4_rotate(VM* vm, int argc, scm_obj_t argv[])
{
