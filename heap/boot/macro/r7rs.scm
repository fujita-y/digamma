                       ...
                       (if (null? clauses)
                           ...
                           (destructuring-match clauses
                             ...
                             ((('include (? string? path)) more ...)
                              (loop (cons (cons 'begin (read-include-file library-name path 'include)) more) exports imports depends commands))
                             ((('include-ci (? string? path)) more ...)
                              (loop (cons (cons 'begin (read-include-file library-name path 'include-ci)) more) exports imports depends commands))
                             ((('include-library-declarations (? string? path)) more ...)
                              (loop (append (read-include-file library-name path 'include-library-declarations) more) exports imports depends commands))
