...
(library (digamma glut)
  ...
  (define-function void glutInitDisplayString (void*))
  ...
  (define-function int glutCreateWindow (void*))
  ...
  (define-function void glutSetWindowTitle (void*))

  ;; void glutSetIconTitle(const char *title)
  (define-function void glutSetIconTitle (void*))
  ...
  (define-function void glutCreateMenu (void*))
  ...
  (define-function void glutAddMenuEntry (void* int))

  ;; void glutAddSubMenu(const char *label, int submenu)
  (define-function void glutAddSubMenu (void* int))

  ;; void glutChangeToMenuEntry(int item, const char *label, int value)
  (define-function void glutChangeToMenuEntry (int void* int))

  ;; void glutChangeToSubMenu(int item, const char *label, int submenu)
  (define-function void glutChangeToSubMenu (int void* int))
  ...
  (define-function void glutReshapeFunc (void*))

  ;; void glutKeyboardFunc(void (*func)(unsigned char key, int x, int y))
  (define-function void glutKeyboardFunc (void*))

  ;; void glutMouseFunc(void (*func)(int button, int state, int x, int y))
  (define-function void glutMouseFunc (void*))

  ;; void glutMotionFunc(void (*func)(int x, int y))
  (define-function void glutMotionFunc (void*))

  ;; void glutPassiveMotionFunc(void (*func)(int x, int y))
  (define-function void glutPassiveMotionFunc (void*))

  ;; void glutEntryFunc(void (*func)(int state))
  (define-function void glutEntryFunc (void*))

  ;; void glutVisibilityFunc(void (*func)(int state))
  (define-function void glutVisibilityFunc (void*))

  ;; void glutIdleFunc(void (*func)(void))
  (define-function void glutIdleFunc (void*))

  ;; void glutTimerFunc(unsigned int millis, void (*func)(int value), int value)
  (define-function void glutTimerFunc (int void* int))

  ;; void glutMenuStateFunc(void (*func)(int state))
  (define-function void glutMenuStateFunc (void*))

  ;; void glutSpecialFunc(void (*func)(int key, int x, int y))
  (define-function void glutSpecialFunc (void*))

  ;; void glutSpaceballMotionFunc(void (*func)(int x, int y, int z))
  (define-function void glutSpaceballMotionFunc (void*))

  ;; void glutSpaceballRotateFunc(void (*func)(int x, int y, int z))
  (define-function void glutSpaceballRotateFunc (void*))

  ;; void glutSpaceballButtonFunc(void (*func)(int button, int state))
  (define-function void glutSpaceballButtonFunc (void*))

  ;; void glutButtonBoxFunc(void (*func)(int button, int state))
  (define-function void glutButtonBoxFunc (void*))

  ;; void glutDialsFunc(void (*func)(int dial, int value))
  (define-function void glutDialsFunc (void*))

  ;; void glutTabletMotionFunc(void (*func)(int x, int y))
  (define-function void glutTabletMotionFunc (void*))

  ;; void glutTabletButtonFunc(void (*func)(int button, int state, int x, int y))
  (define-function void glutTabletButtonFunc (void*))

  ;; void glutMenuStatusFunc(void (*func)(int status, int x, int y))
  (define-function void glutMenuStatusFunc (void*))

  ;; void glutOverlayDisplayFunc(void (*func)(void))
  (define-function void glutOverlayDisplayFunc (void*))

  ;; void glutWindowStatusFunc(void (*func)(int state))
  (define-function void glutWindowStatusFunc (void*))

  ;; void glutKeyboardUpFunc(void (*func)(unsigned char key, int x, int y))
  (define-function void glutKeyboardUpFunc (void*))

  ;; void glutSpecialUpFunc(void (*func)(int key, int x, int y))
  (define-function void glutSpecialUpFunc (void*))

  ;; void glutJoystickFunc(void (*func)(unsigned int buttonMask, int x, int y, int z), int pollInterval)
  (define-function void glutJoystickFunc (void* int))
  ...
  (define-function int glutExtensionSupported (void*))
  ...
  (define-function void* glutGetProcAddress (void*))
  ...
  (define-function int glutBitmapLength (void* void*))

  ;; int glutStrokeLength(void *font, const unsigned char *string)
  (define-function int glutStrokeLength (void* void*))
  ...
  (define-function void glutGameModeString (void*))
